 ...
 * @author Test
 */
public class SettingsNgPatient extends javax.swing.JFrame {

    /**
     * Creates new form SettingsNgPatient
     */
    public SettingsNgPatient() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        med.setIcon(new javax.swing.ImageIcon(getClass().getResource("/synergyfinalsproject/Screenshot 2023-12-10 161729.png"))); // NOI18N
        med.setBorder(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SettingsNgPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SettingsNgPatient().setVisible(true);
            }
        });
    }
