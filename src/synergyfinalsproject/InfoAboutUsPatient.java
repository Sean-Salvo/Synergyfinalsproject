 ...
 * @author Test
 */
public class InfoAboutUsPatient extends javax.swing.JFrame {

    /**
     * Creates new form InfoAboutUsPatient
     */
    public InfoAboutUsPatient() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoAboutUsPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InfoAboutUsPatient().setVisible(true);
            }
        });
    }
